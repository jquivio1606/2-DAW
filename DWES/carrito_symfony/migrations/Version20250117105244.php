 ...
 */
final class Version20250117105244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pedidos_productos (id INT AUTO_INCREMENT NOT NULL, pedido_id INT NOT NULL, producto_id INT NOT NULL, cantidad INT NOT NULL, INDEX IDX_2FA411784854653A (pedido_id), INDEX IDX_2FA411787645698E (producto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE pedidos_productos ADD CONSTRAINT FK_2FA411784854653A FOREIGN KEY (pedido_id) REFERENCES pedido (id)');
        $this->addSql('ALTER TABLE pedidos_productos ADD CONSTRAINT FK_2FA411787645698E FOREIGN KEY (producto_id) REFERENCES producto (id)');
    }
