# Documentación del Proyecto: Tienda Online - Fashion Store

## 1. Introducción

### Objetivo de la Web

El objetivo de este proyecto es diseñar e implementar una interfaz web efectiva y atractiva para una tienda en línea llamada "Fashion Store". Este sitio permite a los usuarios explorar, valorar y adquirir ropa, calzado y accesorios a través de una experiencia de compra intuitiva y funcional.
...
- Sección de valoraciones de clientes para generar confianza.
- Interfaz responsiva para mejorar la accesibilidad en móviles y tablets.

## 3. Análisis de Usuarios y Requerimientos

El usuario objetivo de Fashion Store es un comprador de moda en línea, de entre 18 y 45 años, que busca una experiencia de compra rápida, segura y eficiente.
...
- **Menú principal:**
  - Inicio
  - Tienda
  - Contacto (No está implementado)
- **Menú secundario (Tienda):**
  - Ropa
  - Calzado
  - Accesorios
  - Ofertas
...
- **Iconos adicionales:**
  - Carrito de compras (No está implementado)
...
## 6. Implementación y Tecnologías

- **HTML, CSS, JavaScript**: Base del sitio web.
- **Bootstrap**: Diseño responsivo.
- **Axios**: Para obtener productos desde una API.
- **Balsamiq**: Prototipado.

## 7. Conclusiones

Este proyecto destaca la importancia de la planificación y el diseño antes de la implementación. Se logró una interfaz atractiva, funcional y accesible, optimizada para mejorar la experiencia del usuario en la compra de moda en línea.
